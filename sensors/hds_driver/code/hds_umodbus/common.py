...
class Request(object):
    ...
    def send_response(self, values: Optional[list] = None, signed: bool = True) -> None:
        ...
        """
        if (values is not None and not isinstance(values, (list, tuple))) or not isinstance(signed, bool):
            raise ValueError("values must be a sequence or None and signed must be bool")
    ...
    def send_exception(self, exception_code: int) -> None:
        ...
        """
        if not isinstance(exception_code, int) or not 0 <= exception_code <= 0xFF:
            raise ValueError("exception_code must be an integer from 0 to 255")
...
class ModbusException(Exception):
    ...
    def __init__(self, function_code: int, exception_code: int) -> None:
        ...
        Args:
            ...
            exception_code (int): The Modbus exception code.
        """
        if not isinstance(function_code, int) or not isinstance(exception_code, int):
            raise TypeError("function_code and exception_code must be integers")
...
class CommonModbusFunctions(object):
    ...
    def read_coils(self, slave_addr: int, starting_addr: int, coil_qty: int) -> List[bool]:
        ...
        """
        if (
            not isinstance(slave_addr, int)
            or not 0 <= slave_addr <= 247
            or not isinstance(starting_addr, int)
            or not 0 <= starting_addr <= 0xFFFF
            or not isinstance(coil_qty, int)
            or not 1 <= coil_qty <= 2000
        ):
            raise ValueError("invalid slave address, starting address, or coil quantity")
    ...
    def read_discrete_inputs(self, slave_addr: int, starting_addr: int, input_qty: int) -> List[bool]:
        ...
        if (
            ...
            or not isinstance(starting_addr, int)
            or not 0 <= starting_addr <= 0xFFFF
            or not isinstance(input_qty, int)
            or not 1 <= input_qty <= 2000
        ):
            raise ValueError("invalid slave address, starting address, or input quantity")
    ...
    def read_holding_registers(self, slave_addr: int, starting_addr: int, register_qty: int, signed: bool = True) -> Tuple[int, ...]:
        ...
        if (
            ...
            or not isinstance(starting_addr, int)
            or not 0 <= starting_addr <= 0xFFFF
            or not isinstance(register_qty, int)
            or not 1 <= register_qty <= 125
            or not isinstance(signed, bool)
        ):
            raise ValueError("invalid holding-register read parameters")
    ...
    def read_input_registers(self, slave_addr: int, starting_addr: int, register_qty: int, signed: bool = True) -> Tuple[int, ...]:
        ...
        if (
            ...
            raise ValueError("invalid input-register read parameters")
    ...
    def write_single_coil(self, slave_addr: int, output_address: int, output_value: Union[int, bool]) -> bool:
        ...
        if (
            not isinstance(slave_addr, int)
            or not 0 <= slave_addr <= 247
            or not isinstance(output_address, int)
            or not 0 <= output_address <= 0xFFFF
            or output_value not in (False, True, 0, 1)
        ):
            raise ValueError("invalid single-coil write parameters")
    ...
    def write_single_register(self, slave_addr: int, register_address: int, register_value: int, signed: bool = True) -> bool:
        ...
        if (
            not isinstance(slave_addr, int)
            or not 0 <= slave_addr <= 247
            or not isinstance(register_address, int)
            or not 0 <= register_address <= 0xFFFF
            or not isinstance(register_value, int)
            or not isinstance(signed, bool)
        ):
            raise ValueError("invalid single-register write parameters")
    ...
    def write_multiple_coils(self, slave_addr: int, starting_address: int, output_values: List[Union[int, bool]]) -> bool:
        ...
        if (
            not isinstance(slave_addr, int)
            or not 0 <= slave_addr <= 247
            or not isinstance(starting_address, int)
            or not 0 <= starting_address <= 0xFFFF
            or not isinstance(output_values, (list, tuple))
            or not 1 <= len(output_values) <= 1968
        ):
            raise ValueError("invalid multiple-coil write parameters")
    ...
    def write_multiple_registers(self, slave_addr: int, starting_address: int, register_values: List[int], signed: bool = True) -> bool:
        ...
        if (
            ...
            or not isinstance(starting_address, int)
            or not 0 <= starting_address <= 0xFFFF
            or not isinstance(register_values, (list, tuple))
            or not 1 <= len(register_values) <= 123
            or not isinstance(signed, bool)
        ):
            raise ValueError("invalid multiple-register write parameters")
